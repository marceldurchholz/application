...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(jQuery, _) {var __extends = (this && this.__extends) || function (d, b) {
	...
	var App1_1 = __webpack_require__(659);
	var App2_1 = __webpack_require__(666);
	var App3_1 = __webpack_require__(679);
	var App6_1 = __webpack_require__(696);
	var App7_1 = __webpack_require__(731);
	var core_2 = __webpack_require__(1);
	var EntryPanel_1 = __webpack_require__(768);
	var AppManager_1 = __webpack_require__(766);
	var CommBroker_1 = __webpack_require__(7);
	var Filemenu_1 = __webpack_require__(325);
	var FilemenuItem_1 = __webpack_require__(771);
	var Logo_1 = __webpack_require__(772);
	var RefreshTheme_1 = __webpack_require__(36);
	var Conts_1 = __webpack_require__(11);
	var StyleService_1 = __webpack_require__(137);
	...
	var App = (function (_super) {
	    ...
	    App = __decorate([
	        ...
	        router_2.RouteConfig([
	            ...
	            { path: '/App7', component: App7_1.App7, as: 'App7', useAsDefault: true },
	        ]), 
	...
	var tableObjectArray = [
	    {
	        ...
	        "unique_key": "custreg_id"
	    }, {
	        "table_name": "field_sales_task",
	        "unique_key": "fst_id"
	    }, {
	        "table_name": "field_sales_task_instance",
	        "unique_key": "fsti_id"
	    }, {
	        "table_name": "fremdwaehrung",
	        "unique_key": "currency_id"
	    }, {
	        "table_name": "kunde",
	        "unique_key": "kund_id"
	    }, {
	        "table_name": "kundengruppe",
	        "unique_key": "kungrp_id"
	    }, {
	        "table_name": "kundenkondition",
	        "unique_key": "kundkond_id"
	    }, {
	        "table_name": "kundenlistung",
	        "unique_key": "kundlist_id"
	    }, {
	        "table_name": "kundenverbund",
	        "unique_key": "verbund_id"
	    }, {
	        "table_name": "pictures",
	        "unique_key": "pic_id"
	    }, {
	        "table_name": "product_pricelist_promotion",
	        "unique_key": "pplp_id"
	    }, {
	        "table_name": "produkt",
	        "unique_key": "prod_id"
	    }, {
	        "table_name": "promotion_bundle",
	        "unique_key": "pmb_id"
	    }, {
	        "table_name": "promotion_bundle_line",
	        "unique_key": "pmbl_id"
	    }, {
	        "table_name": "rel_prodnach",
	        "unique_key": "prodnach_id"
	    }, {
	        "table_name": "relation_pictures_hash",
	        "unique_key": "rph_id"
	    }, {
	        "table_name": "relation_product_inventory",
	        "unique_key": "prodinv_id"
	    }, {
	        "table_name": "customer_visit",
	        "unique_key": "cuvis_id"
	    }, {
	        "table_name": "customer_visit_line",
	        "unique_key": "cuvisl_id"
	    }, {
	        "table_name": "customer_visit_line_upload_log",
	        "unique_key": "cuvisllog_id"
	    }, {
	        "table_name": "customer_visit_upload_log",
	        "unique_key": "cuvislog_id"
	    }, {
	        "table_name": "defined_filter",
	        "unique_key": "df_id"
	    }, {
	        "table_name": "defined_filter_upload_log",
	        "unique_key": "dflog_id"
	    }, {
	        "table_name": "field_sales_task_instance_upload_log",
	        "unique_key": "fstilog_id"
	    }, {
	        "table_name": "field_sales_task_upload_log",
	        "unique_key": "fstlog_id"
	    }, {
	        "table_name": "kontakt_upload_log",
	        "unique_key": "apalog_id"
	    }, {
	        "table_name": "log_installer_package_transfer",
	        "unique_key": "lipt_id"
	    }, {
	        "table_name": "log_installer_state",
	        "unique_key": "lis_id"
	    }, {
	        "table_name": "onion_installer_process_log",
	        "unique_key": "oiplog_id"
	    }
	];
	var startUp = function () {
	    var waitForStartup = 3000;
	    ...
	    setTimeout(function () {
	        ...
	        browser_1.bootstrap(App, [router_1.ROUTER_PROVIDERS, http_1.HTTP_PROVIDERS,
	            core_2.provide(CommBroker_1.CommBroker, { useClass: CommBroker_1.CommBroker }),
	            core_2.provide(Conts_1.Consts, { useClass: Conts_1.Consts }),
	            core_2.provide(router_2.LocationStrategy, { useClass: router_2.HashLocationStrategy })])
	            .catch(function (err) {
	...
	var row_max = _.size(tableObjectArray);
	var doLoop = function (row) {
	    var v = tableObjectArray[row];
	    logmsg("importing " + (v.table_name));
	    try {
	        var db = window.sqlitePlugin.openDatabase({ name: (v.table_name) + ".db", location: 2, createFromLocation: 1 });
	        db.transaction(function (tx) {
	            tx.executeSql("select count(" + (v.unique_key) + ") as cnt from " + (v.table_name) + ";", [], function (tx, res) {
	                logmsg("found in " + (v.table_name) + ": " + res.rows.item(0).cnt);
	                if (row >= _.size(tableObjectArray))
	                    startUp();
	                else {
	                    row++;
	                    doLoop(row);
	...
	var onDeviceReady = function (mobileStartup) {
	    ...
	    if (mobileStartup == true) {
	        ...
	        console.log("startup a desktop pc");
	        startUp();
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Conts_1 = __webpack_require__(11);
	var Observable_1 = __webpack_require__(3);
	var DiggLoader_1 = __webpack_require__(767);
	var CommBroker_1 = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(1);
	var Menu_1 = __webpack_require__(87);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(1);
	var LocalStorage_1 = __webpack_require__(773);
	var StyleModel_1 = __webpack_require__(136);
	var CommBroker_1 = __webpack_require__(7);
	var Conts_1 = __webpack_require__(11);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _applyMiddleware = __webpack_require__(463);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(1);
	var tabs_1 = __webpack_require__(135);
	var Tab = (function () {
	    function Tab(tabs) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isHostObject = __webpack_require__(466),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var router_2 = __webpack_require__(16);
	var Menu_1 = __webpack_require__(87);
	var MenuItem_1 = __webpack_require__(134);
	var CommBroker_1 = __webpack_require__(7);
	var Conts_1 = __webpack_require__(11);
	var Sliderpanel_1 = __webpack_require__(15);
	var Digg_1 = __webpack_require__(132);
	var tabs_1 = __webpack_require__(135);
	var tab_1 = __webpack_require__(205);
	var Logout_1 = __webpack_require__(133);
	var Settings_1 = __webpack_require__(662);
	var Help_1 = __webpack_require__(660);
	var Todo1_1 = __webpack_require__(663);
	var Todo2_1 = __webpack_require__(664);
	var Todolist_1 = __webpack_require__(665);
	var Todoitem_1 = __webpack_require__(320);
	var TodoStatsModel_1 = __webpack_require__(192);
	var RefreshTheme_1 = __webpack_require__(36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Conts_1 = __webpack_require__(11);
	var Sliderpanel_1 = __webpack_require__(15);
	var Notes_1 = __webpack_require__(668);
	var Notes1_1 = __webpack_require__(669);
	var Notes2_1 = __webpack_require__(671);
	var Notes3_1 = __webpack_require__(672);
	var Notes4_1 = __webpack_require__(673);
	var Notes5_1 = __webpack_require__(674);
	var Digg_1 = __webpack_require__(132);
	var http_1 = __webpack_require__(17);
	var Logout_1 = __webpack_require__(133);
	var Contact_1 = __webpack_require__(667);
	var DividerPanel_1 = __webpack_require__(202);
	var ModalDialog_1 = __webpack_require__(35);
	var Properties_1 = __webpack_require__(675);
	var Weather_1 = __webpack_require__(677);
	var RefreshTheme_1 = __webpack_require__(36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MailModel_1 = __webpack_require__(64);
	var CommBroker_1 = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommBroker_1 = __webpack_require__(7);
	var Conts_1 = __webpack_require__(11);
	var NotesBase_1 = __webpack_require__(84);
	var MailModel_1 = __webpack_require__(64);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var router_1 = __webpack_require__(16);
	var router_2 = __webpack_require__(16);
	var Starwars_1 = __webpack_require__(680);
	var App3 = (function () {
	    function App3() {
	    }
	    App3 = __decorate([
...
/***/ function(module, exports, __webpack_require__) {
	...
	var thunk = __webpack_require__(179);
	var parts_reducer_1 = __webpack_require__(694);
	var cart_reducer_1 = __webpack_require__(691);
	var films_reducer_1 = __webpack_require__(692);
	var users_reducer_1 = __webpack_require__(695);
	var angular2_redux_util_1 = __webpack_require__(20);
	var shopping_component_1 = __webpack_require__(688);
	var CommBroker_1 = __webpack_require__(7);
	var part_actions_1 = __webpack_require__(125);
	var cart_actions_1 = __webpack_require__(193);
	var Consts = __webpack_require__(124);
	var admin_component_1 = __webpack_require__(682);
	var films_component_1 = __webpack_require__(686);
	var user_actions_1 = __webpack_require__(195);
	var film_actions_1 = __webpack_require__(194);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(1);
	var user_actions_1 = __webpack_require__(195);
	var users_view_1 = __webpack_require__(690);
	var user_view_1 = __webpack_require__(689);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(1);
	var Simplelist_1 = __webpack_require__(204);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var router_1 = __webpack_require__(16);
	var router_2 = __webpack_require__(16);
	var Newsboard_1 = __webpack_require__(700);
	var http_1 = __webpack_require__(17);
	var Menu_1 = __webpack_require__(87);
	var MenuItem_1 = __webpack_require__(134);
	var CommBroker_1 = __webpack_require__(7);
	...
	var tab_1 = __webpack_require__(205);
	var Logout_1 = __webpack_require__(133);
	var Settings_1 = __webpack_require__(724);
	var Help_1 = __webpack_require__(698);
	var Todo1_1 = __webpack_require__(725);
	var Todo2_1 = __webpack_require__(726);
	var Todolist_1 = __webpack_require__(727);
	var Todoitem_1 = __webpack_require__(322);
	var TodoStatsModel_1 = __webpack_require__(128);
	var RefreshTheme_1 = __webpack_require__(36);
	var Notes_1 = __webpack_require__(716);
	var Notes1_1 = __webpack_require__(717);
	var Notes2_1 = __webpack_require__(719);
	var Notes3_1 = __webpack_require__(720);
	var Notes4_1 = __webpack_require__(721);
	var Notes5_1 = __webpack_require__(722);
	var Contact_1 = __webpack_require__(697);
	var DividerPanel_1 = __webpack_require__(202);
	var ModalDialog_1 = __webpack_require__(35);
	var Properties_1 = __webpack_require__(723);
	var Weather_1 = __webpack_require__(729);
	...
	var TodoList = (function () {
	    ...
	    TodoList.prototype.ngAfterContentInit = function () {
	        ...
	        vm.registerScanner()
	            ...
	            .catch(function (err) {
	            vm.logmsg("SCANNER ERROR DURING INIT");
	            vm.logerr(err);
	        });
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var router_1 = __webpack_require__(16);
	var router_2 = __webpack_require__(16);
	var Newsboard_1 = __webpack_require__(735);
	var http_1 = __webpack_require__(17);
	var Menu_1 = __webpack_require__(87);
	var MenuItem_1 = __webpack_require__(134);
	var CommBroker_1 = __webpack_require__(7);
	...
	var tab_1 = __webpack_require__(205);
	var Logout_1 = __webpack_require__(133);
	var Settings_1 = __webpack_require__(759);
	var Help_1 = __webpack_require__(733);
	var Todo1_1 = __webpack_require__(760);
	var Todo2_1 = __webpack_require__(761);
	var Todolist_1 = __webpack_require__(762);
	var Todoitem_1 = __webpack_require__(324);
	var TodoStatsModel_1 = __webpack_require__(131);
	var RefreshTheme_1 = __webpack_require__(36);
	var Notes_1 = __webpack_require__(751);
	var Notes1_1 = __webpack_require__(752);
	var Notes2_1 = __webpack_require__(754);
	var Notes3_1 = __webpack_require__(755);
	var Notes4_1 = __webpack_require__(756);
	var Notes5_1 = __webpack_require__(757);
	var Contact_1 = __webpack_require__(732);
	var DividerPanel_1 = __webpack_require__(202);
	var ModalDialog_1 = __webpack_require__(35);
	var Properties_1 = __webpack_require__(758);
	var Weather_1 = __webpack_require__(764);
	    ...
	    TodoList.prototype.goSearch = function (req, valueObject) {
	        ...
	        db.transaction(function (tx) {
	            vm.getProductByBarcode(tx, req, valueObject, function (tx, responseSuccess) {
	                ...
	                vm.logmsg(JSON.stringify(responseSuccess));
	                vm.zone.run(function () {
	                    vm.todoStatModel.qty = _.size(responseSuccess.rows);
	                    var len = responseSuccess.rows.length;
	                    for (var i = 0; i < len; i++) {
	                ...
	                vm.logmsg(JSON.stringify(responseError));
	                vm.zone.run(function () {
	                    vm.logmsg('ERROR! Could not execute the SQL statement!');
	                    vm.todoStatModel.status = "Code " + responseError.code + ": " + responseError.message;
	                });
	            });
	        }, vm.logerr);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(1);
	var ForgotPass_1 = __webpack_require__(769);
	var LoginPanel_1 = __webpack_require__(770);
	var router_1 = __webpack_require__(16);
	var router_2 = __webpack_require__(16);
	var CommBroker_1 = __webpack_require__(7);
	var Conts_1 = __webpack_require__(11);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommBroker_1 = __webpack_require__(7);
	var Conts_1 = __webpack_require__(11);
	var router_3 = __webpack_require__(16);
	__webpack_require__(111);
	__webpack_require__(44);
	__webpack_require__(28);
	__webpack_require__(181);
	...
	var Subject_1 = __webpack_require__(19);
	var BehaviorSubject_1 = __webpack_require__(186);
	var Observable_1 = __webpack_require__(3);
	var User = (function () {
	    function User(obj) {
